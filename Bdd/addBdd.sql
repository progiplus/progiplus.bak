...
INSERT INTO client (code_client, raison_sociale)
VALUES 
("Cl28",NULL),
("ClPro25","Peinture and Co"),
("Cl29",NULL),
("ClPro30","Le roi du bricolage");
...
INSERT INTO devis(date_devis, duree_validite,actif,id_client)
VALUES
("2018-10-22",30,1,1),
("2018-10-12",30,1,2),
("2018-08-14",30,0,3),
...
INSERT INTO bl(date_bl,actif,id_client,id_adresse,id_facture)
VALUES 
("2018-10-22",1,1,1,1),
("2018-10-22",1,2,2,2);

INSERT INTO ligne_bl(quantite,reference,id_bl)
VALUES (3,"S9",1),(2,"S8",1),(1,"10",1),(7,"6",2);