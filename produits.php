...
<script type="text/javascript">
    ...
    var modalModif = document.getElementById("modal_modif_produit");
    for(var i=0; i<btnModif.length; i++)
    {
        btnModif[i].onclick = function()
        {
    ...
    var modalAjout = document.getElementById("modal_ajouter_produit");
    var btnAjout = document.getElementById("bouton_ajouter");
